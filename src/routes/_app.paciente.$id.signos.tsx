        ...
        {adding ? (
          <section className="rounded-3xl bg-card border border-border/60 p-5 space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <Field label="Presión Arterial Sistólica" unit="" value={form.ta_sistolica} onChange={(v) => setForm({ ...form, ta_sistolica: v })} />
              <Field label="Presión Arterial Diastólica" unit="" value={form.ta_diastolica} onChange={(v) => setForm({ ...form, ta_diastolica: v })} />
