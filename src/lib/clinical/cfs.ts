...
export const CFS_LEVELS: { value: number; label: string; desc: string }[] = [
  ...
  { value: 5, label: "Fragilidad leve", desc: "Requiere ayuda en actividades instrumentales." },
  ...
  { value: 8, label: "Muy severa", desc: "Dependiente total, próximo al final de la vida." },
